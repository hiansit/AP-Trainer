const i18nData = {
    'ja': {
        ...
        home: {
            ...
            level: "🎯 レベル",
            level1: "Level 1 — 1オクターブ (C4-B4)",
            level2: "Level 2 — 2オクターブ (C3-B4)",
            level3: "Level 3 — 4オクターブ (C2-B5)",
            questions: "📝 問題数",
            qCount: "{n} 問",
            startBtn: "▶ トレーニング開始",
            historyBtn: "📊 学習履歴",
    ...
    'en': {
        ...
        home: {
            ...
            level: "🎯 Level",
            level1: "Level 1 — 1 Octave (C4-B4)",
            level2: "Level 2 — 2 Octaves (C3-B4)",
            level3: "Level 3 — 4 Octaves (C2-B5)",
            questions: "📝 Questions",
            qCount: "{n} Qs",
    ...
    'zh-TW': {
        ...
        home: {
            ...
            level: "🎯 等級",
            level1: "Level 1 — 1 個八度 (C4-B4)",
            level2: "Level 2 — 2 個八度 (C3-B4)",
            level3: "Level 3 — 4 個八度 (C2-B5)",
            questions: "📝 題數",
            qCount: "{n} 題",
            startBtn: "▶ 開始訓練",
            historyBtn: "📊 學習紀錄",
